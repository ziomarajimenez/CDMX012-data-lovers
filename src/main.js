...
for(let j = 0; j < allFilms.length; j++){
    ...
    // Verificar si la descripción es mayor a cierto número de caracteres y 
    // si los sobrepasa ponerle ... para que corte el texto y no sea problema
    // en la tarjeta de descripción
